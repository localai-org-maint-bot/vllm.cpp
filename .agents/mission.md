...
Public positioning, including badges, distinguishes registered architectures
from those with a passing correctness gate, and scopes every performance claim
to the exact checkpoint and workload that produced it.
