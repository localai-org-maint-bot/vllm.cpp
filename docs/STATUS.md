...
| IndexTTS-2.5 speech generation (`MODEL-MM-indextts2`, ACTIVE, unavailable) | CPU-gated foundations only; load refuses by name | Speech seam, detector, GPT-2, BigVGAN, and partial CAMPPlus landed. Conditioning, codec, S2Mel, composition, routes, C ABI, and the oracle pin remain open. No synthesis or speed claim (#633, #634) |
